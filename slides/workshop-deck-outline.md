...
Codex for Scientific Staff: Local Evidence, Clear Outputs, Reproducible Work

## Slide 2: What We Are Training

- Not prompt tricks.
- Not blind automation.
- A repeatable way to ask Codex for careful work.

## Slide 3: The Operating Pattern

1. Give context.
2. Inspect local evidence.
3. Produce a useful artifact.
4. Verify.
5. Leave a handoff.

## Slide 4: Good Scientific Staff Use Cases

- Software inventory summaries
- Spreadsheet model checks
